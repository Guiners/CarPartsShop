                ...
                <div>
                    {isPaid ? (
                        ...
                        <div>
                            <h2>Price To Pay</h2>
                            <h3>{order.price}</h3>
                            <button style={getStyles().button} onClick={realizeOrder}>Pay for order</button>
                        </div>
                    )}
                </div>
            ) : (
                <div>
                    <Address style={getStyles().addressContainer} />
                    <button style={{ ...getStyles().button, ...getStyles().centeredButton }} onClick={createOrder}>Create Order</button>
                 </div>
            )}
